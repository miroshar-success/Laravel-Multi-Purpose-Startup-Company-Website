                        ...
                        <div class="p-3">
                            <div class="mb-3">
                                <span
                                    ...
                                    :style="[
                                        child_customer.avatar_url
                                            ? { backgroundImage: 'url(' + child_customer.avatar_url + ')' }
                                            : {},
                                    ]"
                                ></span>
                            </div>
        ...
        createNewCustomer: function (event) {
            ...
            axios
                .post(route('customers.create-customer-when-creating-order'), {
                    ...
                    country: context.child_customer_address.country.toString(),
                    state: context.child_customer_address.state.toString(),
                    city: context.child_customer_address.city.toString(),
